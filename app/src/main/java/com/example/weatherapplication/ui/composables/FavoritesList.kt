...
@Composable
fun FavoritesList(
    favoriteCities: List<CitySearchItem>,
    ...
    if (favoriteCities.isEmpty()) {
        ...
        LazyColumn(
            ...
            items(items = favoriteCities) { city ->
                FavoriteCityRow(city = city, onClick = {
...
fun FavoriteCityRow(
    ...
    Row(
        ...
        Column {
            ...
            // Tutaj możesz dopisać inne pola: czas, temperatura, ciśnienie itd.
            // Będziesz jednak potrzebować tych danych do przekazania w modelu!
        }
    }
}
